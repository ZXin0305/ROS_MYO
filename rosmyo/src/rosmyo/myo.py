...
class Myo(WorkerThread):
	...
	CLASS_ABBR = 'Myo'
	MAX_CONNECTIONS = 3
	MYO_ADVERTISE_UUID = '\x42\x48\x12\x4a\x7f\x2c\x48\x47\xb9\xde\x04\xa9\x01\x00\x06\xd5'  # total 16
	# print(len(MYO_ADVERTISE_UUID))
	# Costructors
	def __init__(self, dongle):
		...
		self.__wq_emg = None
		self.__filter_emg = _filter_emg  # emg value
